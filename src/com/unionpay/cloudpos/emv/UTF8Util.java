...
class UTF8Util
{
     ...
     */
    private static int bytes2charsUTF8(byte[] buf, int bufOffset, int bufLength, char[] cbuf,
            boolean bigEndian)
    {
     ...
     * @return
     */
    static String bytes2StringUTF8(byte[] buf, int bufOffset, int bufLength, boolean bigEndian)
    {
    ...
    static String bytes2StringUTF8(byte[] buf)
    {
    ...
    static byte[] string2BytesUTF8(String str)
    {
    ...
    static int char2ByteUTF8(String input, int inOff, int inEnd, byte[] output, int outOff,
            int outEnd, boolean getLengthFlag)
    {
        char inputChar;
        int outputSize;
     ...
     * @return
     */
    static String bytes2StringUNICODE(byte[] buf, int offset, int length, boolean bigEndian) {
