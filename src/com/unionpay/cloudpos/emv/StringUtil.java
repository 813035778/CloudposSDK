...
class StringUtil
{
    ...
    static int getSaveConvertLength(String theString) {
        return saveConvert(theString, null, 0, true, true, true);
    }

    static int saveConvert(String theString, byte[] dst, int offset) {
     ...
     */
    static int saveConvert(String theString, byte[] dst, int offset, boolean escapeSpace,
            boolean lengthFlag, boolean getLengthFlag)
    {
        if (!getLengthFlag
                && (null == dst
     ...
     */
    static String loadConvert(byte[] s, int offset, boolean lengthFlag)
    ...
    static String returnString(int intValue) {
        return intValue < 0 ? "" : "" + intValue;
    }

    static String returnString(short shortValue) {
        return returnString((int) shortValue);
    }

    static String returnString(byte byteValue) {
     ...
     */
    static String trimSpace(String oldString) {
        if (null == oldString)
            return null;
     ...
     * @param trimFlag The trim flag, =0:trim both sides, >0:trim right sides,
     *            <0:trim left sides,
     */
    static String trimSpace(String oldString, int trimFlag)
    {
        if (null == oldString)
            return null;
        if (0 == oldString.length())
        ...
        for (; j < length
                && (oldString.charAt(length - 1) == ' ' || oldString.charAt(length - 1) == '\0'); length--)
            ;
     ...
     * @param The string to be format.
     */
    static String toString(byte abyte0[]) {
        return (null == abyte0) ? null : new String(abyte0);
    }

    static String[] buffer2Message(String bufferString, int width, int height)
    {
        int buffLen;
        int i = 0;
        int h, w;
     ...
     * @param The string to be format.
     */
    static String[] buffer2Message(String bufferString) {
     ...
     * @param The string to be format.
     */
    static String fillString(String formatString, int length, char fillChar, boolean leftFillFlag) {
     ...
     * @param The string to be format.
     */
    static String fillSpace(String formatString, int length) {
     ...
     * @param The string to be format.
     */
    static String formatLine(String formatString, boolean leftFillFlag) {
     ...
     * @param The string to be format.
     */
    static String fillShowSpace(String formatString) {
        if (null == formatString)
            return "";
    ...
    static String fillZero(int value, int length) {
     ...
     * @param The string to be format.
     */
    static String fillZero(String formatString, int length) {
     ...
     * @return byte array
     */
    static byte[] hexString2bytes(String s) {
        if (null == s)
            return null;
     ...
     * @return byte[len]
     */
    static byte[] hex2byte(String s, int offset, int len) {
        byte[] d = new byte[len];
        int byteLen = len * 2;
    ...
    static String toHexString(byte abyte0[], int beginIndex, int endIndex, boolean spaceFlag) {
        if (null == abyte0)
            return null;
        if (0 == abyte0.length)
            return "";
    ...
    static String toHexString(byte abyte0[], int beginIndex, int endIndex) {
        if (null == abyte0)
            return null;
        return toHexString(abyte0, beginIndex, endIndex, true);
    }

    static String toHexString(byte abyte0[], boolean spaceFlag) {
     ...
     * @param The string to be format.
     */
    static String toFullString(byte abyte0[]) {
     ...
     * @param The string to be format.
     */
    static String toBestString(byte abyte0[]) {
        boolean flag = false;
        if (abyte0 != null) {
            int byteLen = abyte0.length; // "!flag"低效,宜改用"break;".
                                         // DuanCS@[20140623]
     ...
     * @param The string to be format.
     */
    static boolean isHexChar(String hexString, boolean trimSpaceFlag) {
    ...
    static boolean isHexChar(String hexString) {
     ...
     **/
    static boolean isLetterNumeric(String s) {
     ...
     * 去除两端Space后是空文本?
     */
    static boolean isTrimmedEmpty(CharSequence s) {
     ...
     */
    static boolean hasTrimmedEmpty(CharSequence... ss) {
    ...
    static boolean hasEmpty(CharSequence... ss) {
        for (CharSequence s : ss) {
     ...
     * 参数列表去除两端Space后全为空文本?
     */
    static boolean allTrimmedEmpty(CharSequence... ss) {
        for (CharSequence s : ss) {
            if (getTrimmedLength(s) > 0) {
                return false;
            }
    ...
    static boolean allEmpty(CharSequence... ss) {
        for (CharSequence s : ss) {
            if (!TextUtils.isEmpty(s)) {
                return false;
            }
